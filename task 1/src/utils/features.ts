...
constructor(public mongooseQuery:mongoose.Query<any[], any> , private queryString:any){};
    ...
    const executedFields: string[] = ['page', 'limit', 'sort', 'fields', 'search', 'lang'];//delete this fields if found
    ...
    this.mongooseQuery.sort(sortBy);
        ...
        this.mongooseQuery = this.mongooseQuery.sort("-updatedAt -createdAt");
    return this;
};

    paginations(documentsCount:number){
